...
; score5 db 'WHAT?! How can yobra o terminal e digite make all no diretório com os arquivos "boot1.asm", "boot2.asm", "kernel.asm" e "Makefile"u type that fast? Its like, humanly impossible', 0
